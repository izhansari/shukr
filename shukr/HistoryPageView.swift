...
//    private var availableDates: [Date] {
//        let dates = Set(sessionItems.map { calendar.startOfDay(for: $0.startTime) })
//        return Array(dates).sorted(by: <) // Changed to ascending order
//    }
//    
//    private func sessions(for date: Date) -> [SessionDataModel] {
//        sessionItems
...
////        .scrollPagingEnabled(true) // This enables paging
//    }
//}
...
//// Extension to enable paging on ScrollView
//extension View {
//    func scrollPagingEnabled(_ enabled: Bool) -> some View {
//        self.onAppear {
...
//    @State private var selectedSession: SessionDataModel? = nil
//    @State private var sessionToDelete: SessionDataModel? = nil
...
//    @State private var sessionsByDate: [Date: [SessionDataModel]] = [:]
...
//    }
//    
//    // Optimized filtering function that uses cache
//    func filteredSessions(for date: Date) -> [SessionDataModel] {
//        let calendar = Calendar.current
//        let startOfDay = calendar.startOfDay(for: date)
//        
//        // Return cached result if available
//        if let cachedSessions = sessionsByDate[startOfDay] {
//            return cachedSessions
//        }
//        
//        // Filter and cache result
//        let filtered = sessionItems.filter { session in
//            calendar.isDate(session.startTime, inSameDayAs: date)
//        }
//        sessionsByDate[startOfDay] = filtered
//        return filtered
//    }
//    
...
//                                                }
//                                            }
////                                            FooterText(sessionCount: sessionsForDay.count, index: index)
//                                        }
//                                    }
//                                }
//                            }
