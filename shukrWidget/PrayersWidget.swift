...
//class PrayersWidgetLocationManager: NSObject, ObservableObject, CLLocationManagerDelegate {
...
//    @Published var latitude: Double = 0
//    @Published var longitude: Double = 0
//    @Published var locationName: String = "Unknown Location" // Geocoded location name
//    
//    override init() {
//        super.init()
//        locationManager.delegate = self
...
//                // Format location name (e.g., city, country)
